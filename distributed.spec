...
Version  : 2.15.2
Release  : 43
URL      : https://files.pythonhosted.org/packages/58/6a/99cfa97575754123f41a67be8ca81f798c3fa8c22395a00e55d9e19b97be/distributed-2.15.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/58/6a/99cfa97575754123f41a67be8ca81f798c3fa8c22395a00e55d9e19b97be/distributed-2.15.2.tar.gz
...
%prep
%setup -q -n distributed-2.15.2
cd %{_builddir}/distributed-2.15.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588627314
...
cp %{_builddir}/distributed-2.15.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/distributed/f43ec84283c31d12e523a8b1abbf7428fdfa5f6a
