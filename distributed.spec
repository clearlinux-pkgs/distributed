...
Version  : 2.30.1
Release  : 61
URL      : https://files.pythonhosted.org/packages/d6/91/c15699d9046fcff1be1e91b95b825c7eed00c7eb80fff5949ea936a391b4/distributed-2.30.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/d6/91/c15699d9046fcff1be1e91b95b825c7eed00c7eb80fff5949ea936a391b4/distributed-2.30.1.tar.gz
...
%prep
%setup -q -n distributed-2.30.1
cd %{_builddir}/distributed-2.30.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604508512
...
cp %{_builddir}/distributed-2.30.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/distributed/f43ec84283c31d12e523a8b1abbf7428fdfa5f6a
