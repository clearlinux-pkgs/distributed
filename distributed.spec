...
%prep
%setup -q -n distributed-2.9.1
cd %{_builddir}/distributed-2.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578152373
...
cp %{_builddir}/distributed-2.9.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/distributed/f43ec84283c31d12e523a8b1abbf7428fdfa5f6a
