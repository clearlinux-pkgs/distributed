...
Version  : 2.8.0
Release  : 25
URL      : https://files.pythonhosted.org/packages/51/36/b28e86e1de422406d5a33d8e50bd578e0dab699ac11d8e656c6796d88aa5/distributed-2.8.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/51/36/b28e86e1de422406d5a33d8e50bd578e0dab699ac11d8e656c6796d88aa5/distributed-2.8.0.tar.gz
...
%prep
%setup -q -n distributed-2.8.0
cd %{_builddir}/distributed-2.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573790564
...
cp %{_builddir}/distributed-2.8.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/distributed/f43ec84283c31d12e523a8b1abbf7428fdfa5f6a
