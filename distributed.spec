...
Version  : 2.13.0
Release  : 39
URL      : https://files.pythonhosted.org/packages/fc/1f/68f8b28235a004f37a56627385fcdac69207e6bb7fca454d12722f29cee8/distributed-2.13.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/fc/1f/68f8b28235a004f37a56627385fcdac69207e6bb7fca454d12722f29cee8/distributed-2.13.0.tar.gz
...
%prep
%setup -q -n distributed-2.13.0
cd %{_builddir}/distributed-2.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585265780
...
cp %{_builddir}/distributed-2.13.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/distributed/f43ec84283c31d12e523a8b1abbf7428fdfa5f6a
