...
%prep
%setup -q -n distributed-2021.12.0
cd %{_builddir}/distributed-2021.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639414465
...
cp %{_builddir}/distributed-2021.12.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/distributed/f43ec84283c31d12e523a8b1abbf7428fdfa5f6a
