...
Version  : 2.9.2
Release  : 32
URL      : https://files.pythonhosted.org/packages/8b/98/dc442405306cc6ac6300c59ea6a6e718e844a39d198a8a0ec85abb229f28/distributed-2.9.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/8b/98/dc442405306cc6ac6300c59ea6a6e718e844a39d198a8a0ec85abb229f28/distributed-2.9.2.tar.gz
...
%prep
%setup -q -n distributed-2.9.2
cd %{_builddir}/distributed-2.9.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579274909
...
cp %{_builddir}/distributed-2.9.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/distributed/f43ec84283c31d12e523a8b1abbf7428fdfa5f6a
