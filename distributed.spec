...
Version  : 2.9.0
Release  : 29
URL      : https://files.pythonhosted.org/packages/50/e2/5e3e274e86d000faf813bd5760ec6e829c3b15daa8b97ef374f40d475c43/distributed-2.9.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/50/e2/5e3e274e86d000faf813bd5760ec6e829c3b15daa8b97ef374f40d475c43/distributed-2.9.0.tar.gz
...
%prep
%setup -q -n distributed-2.9.0
cd %{_builddir}/distributed-2.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575785852
...
cp %{_builddir}/distributed-2.9.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/distributed/f43ec84283c31d12e523a8b1abbf7428fdfa5f6a
